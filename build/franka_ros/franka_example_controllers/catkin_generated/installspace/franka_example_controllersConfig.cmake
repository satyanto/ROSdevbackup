...
if(NOT "include;/home/robotics/libfranka/include " STREQUAL " ")
  set(franka_example_controllers_INCLUDE_DIRS "")
  set(_include_dirs "include;/home/robotics/libfranka/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'franka_example_controllers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robotics/Development/ROSdev/install/${idir}'.  ${_report}")
    endif()
